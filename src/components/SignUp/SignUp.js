                ...
                <div className="mx-[5px] flex flex-col items-center">
                  <div>
                    ...
                    <Procedure
                      ...
                      number="2"
                      desc="Use the BTC app or BTC web with the link www.btcgroup.win/index/login/register.html?fid=358357 to create your BTC account with just few clicks. This will include your phone number and a strong password to ensure sucurity of your funds.DONT SHARE YOUR PASSWORD WITH ANYBODY."
                    />
                  </div>
